...
export const columns: ColumnDef<Product>[] = [
	{
		accessorKey: "type",
		header: ({ column }) => (
			<div className="text-center px-2 cursor-pointer" onClick={() => column.toggleSorting()}>
				Tipo
	...
	},
  {
	...
	},
	{
		...
		cell: ({ row }) => {
			...
			return (
				<div className={`text-center font-semibold ${amount >= 0 ? "text-green-500" : "text-red-500"}`}>
					{formatted}
				</div>
			);
		},
